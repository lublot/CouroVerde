...
ALTER TABLE obra ADD COLUMN `caminhoImagem1` VARCHAR(300) NULL;
ALTER TABLE obra ADD COLUMN `caminhoImagem2` VARCHAR(300) NULL;
ALTER TABLE obra ADD COLUMN `caminhoImagem3` VARCHAR(300) NULL;
ALTER TABLE obra ADD COLUMN `caminhoImagem4` VARCHAR(300) NULL;
ALTER TABLE obra ADD COLUMN `caminhoImagem5` VARCHAR(300) NULL;
ALTER TABLE obra ADD COLUMN `caminhoModelo3D` VARCHAR(300) NULL;
