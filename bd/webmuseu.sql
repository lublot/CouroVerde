...
CREATE TABLE IF NOT EXISTS `webMuseu`.`RelatorioAcesso` (
  ...
  `numeroInventarioObraMaisVisitada` INT NOT NULL,
  `numeroInventarioObraMenosVisitada` INT NOT NULL,
  PRIMARY KEY (`data`),
  INDEX `fk_RelatorioAcesso_Obra_Mais_Vizitada_idx` (`numeroInventarioObraMaisVisitada` ASC),
  INDEX `fk_RelatorioAcesso_Obra_Menos_Vizitada_idx` (`numeroInventarioObraMenosVisitada` ASC),
  CONSTRAINT `fk_RelatorioAcesso_Obra_Mais_Visitada`
    FOREIGN KEY (`numeroInventarioObraMaisVisitada`)
    REFERENCES `webMuseu`.`Obra` (`numeroInventario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_RelatorioAcesso_Obra_Menos_Visitada`
    FOREIGN KEY (`numeroInventarioObraMenosVisitada`)
    REFERENCES `webMuseu`.`Obra` (`numeroInventario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `webMuseu`.`AcessoObra`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webMuseu`.`AcessoObra` (
  `data` DATE NOT NULL,
  `numeroInventario` INT NOT NULL,
  `quantidade` DOUBLE NULL,
  PRIMARY KEY (`data`, `numeroInventario`),
  CONSTRAINT `fk_AcessoObra_Obra`
    FOREIGN KEY ()
    REFERENCES `webMuseu`.`Obra` ()
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
