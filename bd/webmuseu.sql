...
CREATE TABLE IF NOT EXISTS `webMuseu`.`Arquivo` (
  ...
  UNIQUE INDEX `caminho_UNIQUE` (`caminho` ASC))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `webMuseu`.`RespostaAberta` (
  ...
  INDEX `index3` (),
  INDEX `fk_UsuarioPesquisaPergunta_Pergunta_idx` (`idPergunta` ASC),
...
CREATE TABLE IF NOT EXISTS `webMuseu`.`RespostaFechada` (
  ...
  `idPergunta` INT NOT NULL,
  `idOpcao` INT NOT NULL,
  PRIMARY KEY (`idUsuario`, `idOpcao`, `idPergunta`),
