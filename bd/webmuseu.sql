...
-- -----------------------------------------------------
-- Table `webMuseu`.`UsuarioAcesso`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `webMuseu`.`UsuarioAcesso` (
  ...
  INDEX `fk_UsuarioAcesso_AcessoObra_idx` (`dataAcessoObra` ASC, `numeroInventario` ASC),
  CONSTRAINT `fk_UsuarioAcesso_AcessoObra`
    FOREIGN KEY (`dataAcessoObra` , `numeroInventario`)
    REFERENCES `webMuseu`.`AcessoObra` (`data` , `numeroInventario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
