...
class obraControllerTest extends TestCase {
    ...
    */
    public function testCadastrarObraErro() {
        $this->instancia->configurarAmbienteParaTeste(0, null,'Couro 1', 'Função', 'Origem', 'Procedência', 'Descrição', 0, 0, 'Altura', 'Largura', 'Diâmetro', '10 quilos', '1 metro', 'Materiais', 'Técnicas', 'Autoria', 'Marcas', 'Histórico', 'Modo de Aquisição', 'Data de Aquisição', 'Autor', 'Observações', 'Estado');
