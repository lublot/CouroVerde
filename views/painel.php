<div class="panel" style="margin-top:10vh">
  <div class="panel-heading text-center">
    <h4 class="panel-title">
    <a data-toggle="collapse" data-parent="#accordion2" href="#submenu-obra" class="collapsed">
      Obras
    </a>
    <div id="submenu-obra" class="panel-collapse collapse">
      <div class="panel-body">
          ...
          <a href="" class="link">Gerenciar Obras</a>    
      </div>
    </div>
    </h4> <br>
    ...
    <div id="submenu-noticias" class="panel-collapse collapse">
      <div class="panel-body">
          <a href="" class="link">Cadastrar Notícia</a><br><br>
          <a href="" class="link">Gerenciar Notícias</a>
      </div>
    </div>
    </h4> <br>
