...
listarFuncionarios(); // É executado para alimentar as informações da página
function listarFuncionarios(){

    var ajax = new XMLHttpRequest();
        var endereco = '/'+window.location.pathname.split('/')[1]+'/funcionario/listarTodosFuncionarios'; // Varia, depende do objeto a ser removido
...
function criarBox(dados){
    ...
    icone.setAttribute('class','fa fa-user fa-3x');
...
function configurarInfo(dados){
    ...
    info.appendChild(document.createElement("h5").appendChild(document.createTextNode("Nome: "+dados.nome)));
    info.appendChild(document.createElement('br'));
    info.appendChild(document.createElement("h6").appendChild(document.createTextNode("Matrícula: "+dados.matricula)));
    return info;
}
